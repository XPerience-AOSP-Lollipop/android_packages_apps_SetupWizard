...
package mx.xperience.setupwizard.ui;

import static mx.xperience.setupwizard.SetupWizardApp.DISABLE_NAV_KEYS;
import static mx.xperience.setupwizard.SetupWizardApp.KEY_APPLY_DEFAULT_THEME;
import static mx.xperience.setupwizard.SetupWizardApp.KEY_PRIVACY_GUARD;
import static mx.xperience.setupwizard.SetupWizardApp.KEY_SEND_METRICS;
...
public class XPerienceSettingsActivity extends BaseSetupWizardActivity {

    public static final String TAG = XPerienceSettingsActivity.class.getSimpleName();

    public static final String PRIVACY_POLICY_URI = "http://thexperienceproject.com/legal";
