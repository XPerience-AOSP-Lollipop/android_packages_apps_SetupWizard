...
public class SetupWizardUtils {
    ...
    public static void disableSetupWizard(Context context) {
        ...
        disableComponent(context, context.getPackageName(),
                "mx.xperience.setupwizard.ui.WelcomeActivity");
        disableComponent(context, context.getPackageName(),
                "mx.xperience.setupwizard.ui.LocaleActivity");
        disableComponent(context, context.getPackageName(),
                "mx.xperience.setupwizard.ui.XPerienceSettingsActivity");
        disableComponent(context, context.getPackageName(),
                "mx.xperience.setupwizard.ui.FinishActivity");
    }
