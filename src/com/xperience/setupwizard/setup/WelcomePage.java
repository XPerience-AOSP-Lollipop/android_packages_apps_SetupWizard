...
public class WelcomePage extends SetupPage {
    ...
    public boolean doNextAction() {
        if (isLocked()) {
            confirmXPerienceCredentials(mWelcomeFragment);
            return true;
        } else {
    ...
    private void confirmXPerienceCredentials(final Fragment fragment) {
        AccountManager accountManager = AccountManager.get(mContext);
        accountManager.editProperties(SetupWizardApp.ACCOUNT_TYPE_XPERIENCE, null,
