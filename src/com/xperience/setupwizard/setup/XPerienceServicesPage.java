...
public class XPerienceServicesPage extends SetupPage {

    public static final String TAG = "XPerienceServicesPage";

    private Fragment mFragment;

    public XPerienceServicesPage(Context context, SetupDataCallbacks callbacks) {
    ...
    private void launchXPerienceAccountSetup() {
                            ...
                            public void run(AccountManagerFuture<Bundle> future) {
                                ...
                                try {
                                    ...
                                    if (error && getCallbacks().
                                            isCurrentPage(XPerienceServicesPage.this)) {
                                        getCallbacks().onNextPage();
                                    }
                                }
                            }
